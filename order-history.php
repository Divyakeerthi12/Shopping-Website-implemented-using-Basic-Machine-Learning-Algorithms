...
<?php }else{?>
 ...
 <a href="recm.php?pid=<?php echo htmlentities($row['proid']);?>&status=yes" title="Recommendation">
					YES || <a href="recm.php?pid=<?php echo htmlentities($row['proid']);?>&status=no" title="Recommendation">NO
					</td>
				</tr>
<?php $cnt=$cnt+1;} } ?>
