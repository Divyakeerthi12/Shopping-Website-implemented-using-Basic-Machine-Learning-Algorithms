...
include('includes/config.php');
 $command = escapeshellcmd('python Review.py');
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		...
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysqli_query($con,"select distinct bestproduct.productid,products.id,products.productImage1,products.productName,products.productPrice,products.productAvailability from products,bestproduct where products.id=bestproduct.productid");
